...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    loadData: function loadData() {
      ...
      axios.get(window.location.origin + "/api/product").then(function (response) {
        _this.products = response.data;
        _this.locals = JSON.parse(localStorage.getItem('history'));
    ...
    loadcart: function loadcart() {
      ...
      axios.get(window.location.origin + "/api/cart").then(function (response) {
    ...
    history: function history() {
      ...
      axios.post(window.location.origin + "/api/history", {
        ...
        _this3.datas = response.data;
      });
    },
    modal: function modal(index) {
      this.cqty = 1;
    ...
    deletecart: function deletecart(id) {
      ...
      axios["delete"](window.location.origin + "/api/cart/" + id).then(function (response) {
        _this4.session = response.data;
        _this4.totalpesanan;
        _this4.totalharga;
      });
    },
    order: function order(cqt) {
      var _this5 = this;
      ...
      axios.post(window.location.origin + "/api/cart", {
        ...
        _this5.session = response.data;
        _this5.totalharga;
        _this5.totalpesanan; // console.log(JSON.stringify(this.session, null, 2))
      });
    },
    qi: function qi(qty) {
      if (this.cqty >= qty) {
    ...
    checkplaceorder: function checkplaceorder() {
  ...
  computed: {
    totalpesanan: function totalpesanan() {
      var _this7 = this;

      this.totalcart = 0;
      Object.entries(this.session).forEach(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            key = _ref2[0],
            val = _ref2[1];

        return _this7.totalcart += val.cqty; // the value of the current key.
      });
    },
    totalharga: function totalharga() {
      ...
      this.total = 0;
      Object.entries(this.session).forEach(function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            key = _ref4[0],
            val = _ref4[1];

        var kali = val.price * val.cqty;
        _this8.total += kali; // the value of the current key.
      });
    }
  } // filters: {
  // cparse(data){
...
__webpack_require__(/*! F:\Laravel\t_c\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\Laravel\t_c\resources\sass\app.scss */"./resources/sass/app.scss");
